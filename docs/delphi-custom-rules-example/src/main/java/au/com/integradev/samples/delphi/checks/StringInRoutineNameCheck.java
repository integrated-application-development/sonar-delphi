 ...
 * issue when a routine name contains a forbidden string.
 */
@RuleTemplate
@Rule(key = "StringInRoutineName")
public class StringInRoutineNameCheck extends DelphiCheck {
  private static final String DEFAULT_MESSAGE =
      "Rename this routine containing a forbidden string.";

  @RuleProperty(description = "String to forbid in routine names")
