 ...
 * issue each time a method is encountered.
 */
@Rule(key = "MethodDeclaration")
public class MethodDeclarationCheck extends DelphiCheck {
  /**
  ...
  public DelphiCheckContext visit(MethodDeclarationNode node, DelphiCheckContext context) {
    ...
    reportIssue(context, node, "Avoid declaring methods (don't ask why)");
