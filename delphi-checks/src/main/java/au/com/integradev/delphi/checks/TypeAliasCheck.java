...
@DeprecatedRuleKey(ruleKey = "TypeAliasRule", repositoryKey = "delph")
@Rule(key = "TypeAlias")
public class TypeAliasCheck extends DelphiCheck {
  private static final String MESSAGE = "Review this type alias declaration.";
