...
@Rule(key = "ConsecutiveTypeSection")
public class ConsecutiveTypeSectionCheck extends AbstractConsecutiveSectionCheck {
  @Override
  ...
  protected boolean areViolatingSections(DelphiNode first, DelphiNode second) {
    return first instanceof TypeSectionNode && second instanceof TypeSectionNode;
  }
