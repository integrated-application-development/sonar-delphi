...
@Rule(key = "AddressOfSubroutine")
public class AddressOfSubroutineCheck extends DelphiCheck {
  private static final String MESSAGE = "Remove this procedural value referencing a subroutine.";

  @Override
  public DelphiCheckContext visit(UnaryExpressionNode expression, DelphiCheckContext context) {
    if (isAddressOfSubroutine(expression)) {
  ...
  private static boolean isAddressOfSubroutine(UnaryExpressionNode expression) {
