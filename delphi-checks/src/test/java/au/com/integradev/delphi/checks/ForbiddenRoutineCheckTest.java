...
class ForbiddenRoutineCheckTest {
  private static final String UNIT_NAME = "TestUnit";
  private static final String FORBIDDEN_ROUTINE = UNIT_NAME + ".TFoo.Bar";

  private static DelphiCheck createCheck() {
    ForbiddenRoutineCheck check = new ForbiddenRoutineCheck();
    check.blacklist = FORBIDDEN_ROUTINE;
    return check;
  }

  @Test
  void testForbiddenRoutineUsageShouldAddIssue() {
  ...
  @Test
  void testNotUsingForbiddenRoutineShouldNotAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(createCheck())
        .onFile(
            new DelphiTestUnitBuilder()
