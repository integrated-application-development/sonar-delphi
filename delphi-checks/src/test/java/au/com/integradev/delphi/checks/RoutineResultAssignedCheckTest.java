...
class RoutineResultAssignedCheckTest {
  @Test
  void testNotAssignedResultShouldAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new RoutineResultAssignedCheck())
        .onFile(
  ...
  @Test
  void testStubRoutineWithExceptionShouldNotAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new RoutineResultAssignedCheck())
        .onFile(
            new DelphiTestUnitBuilder()
  ...
  @Test
  void testStubRoutineWithAssertFalseShouldNotAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new RoutineResultAssignedCheck())
        .onFile(
            new DelphiTestUnitBuilder()
  ...
  @Test
  void testStubRoutineWithExceptionAndExtraStatementsShouldNotAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new RoutineResultAssignedCheck())
        .onFile(
            new DelphiTestUnitBuilder()
  ...
  @Test
  void testStubRoutineWithAssertFalseAndExtraStatementsShouldNotAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new RoutineResultAssignedCheck())
        .onFile(
            new DelphiTestUnitBuilder()
  ...
  @Test
  void testStubRoutineWithVariableAssignmentsShouldNotAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new RoutineResultAssignedCheck())
        .onFile(
            new DelphiTestUnitBuilder()
