...
class EmptyMethodCheckTest {
  @Test
  void testNonEmptyMethodsShouldNotAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new EmptyMethodCheck())
        .onFile(
  ...
  @Test
  void testEmptyMethodsShouldAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new EmptyMethodCheck())
        .onFile(
            new DelphiTestUnitBuilder()
  ...
  @Test
  void testEmptyExceptionalMethodsWithoutCommentsShouldAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new EmptyMethodCheck())
        .onFile(
            new DelphiTestUnitBuilder()
  ...
  @Test
  void testEmptyExceptionalMethodsWithCommentsShouldNotAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new EmptyMethodCheck())
        .onFile(
            new DelphiTestUnitBuilder()
