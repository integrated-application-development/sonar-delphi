...
class RoutineNestingDepthCheckTest {
  @Test
  void testShallowNestedRoutineShouldNotAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new RoutineNestingDepthCheck())
        .onFile(
  ...
  @Test
  void testDeeplyNestedRoutineShouldAddIssue() {
    CheckVerifier.newVerifier()
        .withCheck(new RoutineNestingDepthCheck())
        .onFile(
            new DelphiTestUnitBuilder()
