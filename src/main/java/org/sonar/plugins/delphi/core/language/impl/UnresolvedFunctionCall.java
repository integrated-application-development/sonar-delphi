...
/**
 * Class used by AbstractAnalyser for unresolved function calls from function body (when we call a function, but didn't read function
 * include file yet)
 */
public class UnresolvedFunctionCall {
   ...
   * 
   * @param caller
   *          Function that has called another function
   * @param called
   *          Called function
   * @param callerUnit
   *          Caller function unit
   */
