...
public class DuplicatesRule extends DelphiRule {
    ...
    /**
     * This rule adds violations when the Duplicates method, (foo.Duplicates := dupError) is called on a list, but the
     * preceding line did not first sort the list (using foo.Sorted := True)
     *
