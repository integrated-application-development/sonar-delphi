...
public class UppercaseReservedWordsRule extends DelphiRule {
  ...
  // highlighting all, not the cleanest method but avoids false positives
  private static final Set<Integer> keywords = new HashSet<>(Arrays.asList(
      ...
      DelphiLexer.FILE, DelphiLexer.FINAL, DelphiLexer.FINALIZATION, DelphiLexer.FINALLY,
      DelphiLexer.FOR, DelphiLexer.FUNCTION, DelphiLexer.GOTO, DelphiLexer.IF,
      DelphiLexer.IMPLEMENTATION, DelphiLexer.IN, DelphiLexer.INHERITED, DelphiLexer.INITIALIZATION,
      DelphiLexer.INLINE, DelphiLexer.INTERFACE, DelphiLexer.IS, DelphiLexer.LABEL,
      DelphiLexer.LIBRARY, DelphiLexer.NIL, DelphiLexer.NOT, DelphiLexer.OF, DelphiLexer.OR,
      DelphiLexer.OUT, DelphiLexer.PACKED, DelphiLexer.PROCEDURE, DelphiLexer.PROGRAM,
      DelphiLexer.PROPERTY, DelphiLexer.PROGRAM, DelphiLexer.PROPERTY, DelphiLexer.RAISE,
      DelphiLexer.RECORD, DelphiLexer.REMOVE, DelphiLexer.REPEAT, DelphiLexer.RESOURCESTRING,
      DelphiLexer.SEALED, DelphiLexer.SET, DelphiLexer.SHL, DelphiLexer.SHR, DelphiLexer.STATIC,
      DelphiLexer.STRICT,  DelphiLexer.THEN, DelphiLexer.THREADVAR, DelphiLexer.TO, DelphiLexer.TRY,
