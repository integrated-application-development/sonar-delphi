...
public class EmptyBracketsRule extends DelphiRule {
    ...
    /**
     * This rule searches for any calls to methods which include brackets () but do not pass any parameters. This
     * is not necessary in Delphi so warnings are raised.
