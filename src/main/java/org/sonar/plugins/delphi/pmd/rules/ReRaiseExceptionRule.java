...
public class ReRaiseExceptionRule extends DelphiRule {
    ...
    /**
     * This rule looks for exception blocks where the exception is raised a second time at the end of the except block.
     * This is done by searching for any begin block (except blocks always contain begin/end blocks) and any children
     * which are 'raise' statements. If the next node after the raise statement is not a semicolon, it is assumed this
     * is a re-raised exception and a violation is raised.
