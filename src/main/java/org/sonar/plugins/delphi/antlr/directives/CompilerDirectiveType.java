...
/**
 * Enum type for compiler directive Put every directive you don't use into UNUSED name string - it will automaticaly supress warnings
 */
public enum CompilerDirectiveType {
  UNKNOWN(0, "unknown_directive"), DEFINE(1, "define"), UNDEFINE(2, "undef"), IF(3, "if"), ELSE(4, "else,elseif"), ENDIF(5, "endif"), IFDEF(
