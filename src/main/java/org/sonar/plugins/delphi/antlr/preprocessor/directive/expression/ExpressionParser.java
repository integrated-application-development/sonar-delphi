...
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.EQUALS;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.GREATER_THAN;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.GREATER_THAN_EQUAL;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.IN;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.LESS_THAN;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.LESS_THAN_EQUAL;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.MINUS;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.MOD;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.MULTIPLY;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.NOT;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.NOT_EQUALS;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.OR;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.PLUS;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.SHL;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.SHR;
import static org.sonar.plugins.delphi.antlr.preprocessor.directive.expression.Token.TokenType.XOR;
