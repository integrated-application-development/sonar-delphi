...
public class PMDReportXMLParser {
    ...
    /**
     * This class parses the pmd report xml file generated by a sonarqube scan. It is then stored in a data structure,
     * a hashmap (file names as keys) pointing to arraylists which store the violated rule type and the line the
     * violation was on.
     */
    ...
    /**
     * Build the Hashmap of lists by iterating through all the 'file' tags and the child 'violation' nodes.
     *
     * Note: It could be better to have this as a hashmap pointing to another hashmap of rules and a list of lines, but
     * as violation nodes in the XML file are not sequential, this is somewhat difficult.
     * @param fileNodes
     */
    private void buildXMLHashmap(NodeList fileNodes){
        ...
        for(int i = 0; i < fileNodes.getLength(); i++){
            ...
            String fileName = StringUtils.substringAfterLast(pathName, "\\"); // FIXME: just a note, does this also work on linux?
