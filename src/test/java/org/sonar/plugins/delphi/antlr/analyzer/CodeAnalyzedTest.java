...
public class CodeAnalyzedTest {
  ...
  /*
   * @Test public void advanceNodeTest() { Tree n = code.getCurrentCodeNode().getNode(); int index = 0; do { assertEquals(nodes[index++],
   * n); code.advanceNode(); n = code.getCurrentCodeNode(); } while (n != null);
   * 
