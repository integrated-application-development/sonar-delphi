...
public class CompilerDirectiveFactoryTest extends FileTestsCommon {
  ...
  @Test
  public void createIfDirectiveTest() throws CompilerDirectiveFactorySyntaxException, CompilerDirectiveFactoryUnsupportedDirectiveException {
  ...
  public void produceTest() throws IOException, CompilerDirectiveFactorySyntaxException {
    ...
    String names[] = { "include", "include", "define", "undefine", "include", "if", "else", "ifend", "ifdef", "ifndef", "ifdef", "else",
        "endif", "else", "if", "ifend", "if", "ifend", "endif", "endif" };
    String items[] = { "include1.inc", "include2.inc", "TEST", "TEST", "error.inc", "I_FEEL_HAPPY", "", "", "TEST", "UseMe",
        "EnableMemoryLeakReporting", "", "", "", "VERSION >= 18", "", "RTLVersion < 18", "", "", "" };
    CompilerDirectiveType types[] = { CompilerDirectiveType.INCLUDE, CompilerDirectiveType.INCLUDE, CompilerDirectiveType.DEFINE,
        CompilerDirectiveType.UNDEFINE, CompilerDirectiveType.INCLUDE, CompilerDirectiveType.IF, CompilerDirectiveType.ELSE,
        CompilerDirectiveType.IFEND, CompilerDirectiveType.IFDEF, CompilerDirectiveType.IFDEF, CompilerDirectiveType.IFDEF,
        CompilerDirectiveType.ELSE, CompilerDirectiveType.ENDIF, CompilerDirectiveType.ELSE, CompilerDirectiveType.IF,
        CompilerDirectiveType.IFEND, CompilerDirectiveType.IF, CompilerDirectiveType.IFEND, CompilerDirectiveType.ENDIF,
