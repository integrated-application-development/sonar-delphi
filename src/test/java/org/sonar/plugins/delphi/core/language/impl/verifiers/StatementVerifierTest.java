...
public class StatementVerifierTest {
  ...
  private static final int FILE_STATEMENT_LINES[] = { 27, 34, 41, 44, 50, 50, 51, 51, 52, 52, 59, 60, 61, 63, 63, 64, 64, 70, 70, 71 };
  ...
  public void createStatementTest() throws StatementVerifierException {
    ...
    while (currentNode.isValid()) {
      ...
      if (currentNode.getNode().getType() == LexerMetrics.FUNCTION_BODY.toMetrics() && lastLineParsed <= currentNode.getNode().getLine()) {
        int beginCount = 1;
