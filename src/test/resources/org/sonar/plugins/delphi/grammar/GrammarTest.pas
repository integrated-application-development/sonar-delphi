...
type
  ...
  myRecord = record
  private
    //visibility not included in rules
  ...
  tctcalebextract = function() : integer;
stdcall;

  tctsetinidir = function(dir : pansichar) : short;
stdcall;

    //callConvention was not included in rule
  ...
  myClass = CLASS( templateClass<myTemplate, string>, blah)
    //<> problems
    property Local : boolean read  FLocal write FLocal;
    //local keyword
    property Items[Index : Integer] : TCrewLinkListItem read GetItem; default;
    //default at end
