...
type
  ...
  public
    ...
    //no violation, interface implementation
    procedure UnusedProcedure;

    //violation
    procedure UsedProcedure;

    //no violation, procedure used
    function bar : integer;

    //no violation, interface implementation
    procedure vii; virtual;

    //no violation, virtual procedure
    procedure viiii; override;

    //no violation, virtual procedure
    procedure readFunc;

    //no violation, used in property
    procedure writeFunc;
