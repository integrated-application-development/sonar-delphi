...
import static org.sonar.plugins.communitydelphi.DelphiPlugin.COMPILER_VERSION_DEFAULT;
...
class TypeFactoryTest {
  ...
  void testSizeOfExtended(Toolchain toolchain, int size) {
    TypeFactory typeFactory = new TypeFactory(toolchain, COMPILER_VERSION_DEFAULT);
