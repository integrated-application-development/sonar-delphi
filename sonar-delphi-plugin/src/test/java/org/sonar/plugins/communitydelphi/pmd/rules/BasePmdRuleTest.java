...
import org.sonar.plugins.communitydelphi.DelphiSensor;
...
import org.sonar.plugins.communitydelphi.utils.PmdLevelUtils;
...
public abstract class BasePmdRuleTest {
  ...
  protected DelphiRule getRule(
      Class<? extends org.sonar.plugins.communitydelphi.pmd.rules.DelphiRule> clazz) {
