...
import org.sonar.plugins.communitydelphi.antlr.ast.node.AncestorListNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.AnonymousMethodNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.AnsiStringTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ArgumentListNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ArrayAccessorNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ArrayConstructorNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ArrayExpressionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ArrayIndicesNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ArrayTypeNode;
...
import org.sonar.plugins.communitydelphi.antlr.ast.node.BlockDeclarationSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.CaseItemStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.CaseStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ClassHelperTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ClassReferenceTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ClassTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.CommonDelphiNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.CompoundStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ConstArraySubTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ConstDeclarationNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ConstSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ConstStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ContainsClauseNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.CustomAttributeListNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.CustomAttributeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.DecimalLiteralNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.DelphiNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ElseBlockNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.EnumElementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.EnumTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ExceptBlockNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ExceptItemNode;
...
import org.sonar.plugins.communitydelphi.antlr.ast.node.FieldDeclarationNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.FieldSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.FileHeaderNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.FileTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.FinalizationSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.FinallyBlockNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ForInStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ForLoopVarDeclarationNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ForLoopVarNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ForLoopVarReferenceNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ForStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ForToStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.FormalParameterListNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.FormalParameterNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.GenericArgumentsNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.GenericDefinitionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.GotoStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.HelperTypeNode;
...
import org.sonar.plugins.communitydelphi.antlr.ast.node.ImplementationSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ImportClauseNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.InitializationSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.IntegerLiteralNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.InterfaceGuidNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.InterfaceSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.InterfaceTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.LabelStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.LibraryDeclarationNode;
...
import org.sonar.plugins.communitydelphi.antlr.ast.node.MethodHeadingNode;
...
import org.sonar.plugins.communitydelphi.antlr.ast.node.MethodParametersNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.MethodResolutionClauseNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.MethodReturnTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.MethodTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.NameDeclarationListNode;
...
import org.sonar.plugins.communitydelphi.antlr.ast.node.NilLiteralNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ObjectTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.PackageDeclarationNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ParenthesizedExpressionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.PointerTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.PrimaryExpressionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ProceduralTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ProcedureReferenceTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ProcedureTypeHeadingNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ProcedureTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.ProgramDeclarationNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.PropertyNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.PropertyReadSpecifierNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.PropertyWriteSpecifierNode;
...
import org.sonar.plugins.communitydelphi.antlr.ast.node.RangeExpressionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.RecordExpressionItemNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.RecordExpressionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.RecordHelperTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.RecordTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.RecordVariantItemNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.RecordVariantSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.RecordVariantTagNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.RepeatStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.RequiresClauseNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.SetTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.SimpleNameDeclarationNode;
...
import org.sonar.plugins.communitydelphi.antlr.ast.node.StringTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.StructTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.SubRangeTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.TextLiteralNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.TryStatementNode;
...
import org.sonar.plugins.communitydelphi.antlr.ast.node.TypeOfTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.TypeParameterNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.TypeReferenceNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.TypeSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.TypeTypeNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.UnaryExpressionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.UnitDeclarationNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.UnitImportNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.UsesClauseNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.VarDeclarationNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.VarSectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.VarStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.VisibilityNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.VisibilitySectionNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.WhileStatementNode;
import org.sonar.plugins.communitydelphi.antlr.ast.node.WithStatementNode;
