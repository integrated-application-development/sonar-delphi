...
public abstract class AbstractDelphiNode implements DelphiNode, MutableDelphiNode {
   ...
   */
  protected AbstractDelphiNode(@Nonnull Token token) {
   ...
   */
  protected AbstractDelphiNode(int tokenType) {
  ...
  public void jjtAddChild(@Nonnull DelphiNode node) {
    AbstractDelphiNode child = (AbstractDelphiNode) node;
    ...
    ((AbstractDelphiNode) node).jjtSetParent(this);
  }
