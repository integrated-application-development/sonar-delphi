...
public final class ConstArrayElementTypeNodeImpl extends TypeNodeImpl
    implements ConstArrayElementTypeNode {
  public ConstArrayElementTypeNodeImpl(Token token) {
    super(token);
  }
