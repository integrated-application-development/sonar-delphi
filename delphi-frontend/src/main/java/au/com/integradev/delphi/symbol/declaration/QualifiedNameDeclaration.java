...
public abstract class QualifiedNameDeclaration extends AbstractNameDeclaration
    implements Qualifiable {
  private final QualifiedName qualifiedName;

  protected QualifiedNameDeclaration(QualifiedNameDeclarationNode node) {
    super(node);
    qualifiedName = node.getQualifiedName();
  }

  protected QualifiedNameDeclaration(QualifiedNameDeclarationNode node, DelphiScope scope) {
    super(node, scope);
    qualifiedName = node.getQualifiedName();
  }
